...
<table>
    <tr>
        <th>[Period]({{site.baseurl}}https://www.powayusd.com/en-US/Schools/HS/DNHS/Calendars/Schedules/Bell-Schedule</th>
        <th>[Start Time]({{site.baseurl}}time.is</th>
        <th>[End Time]({{site.baseurl}}/time.is</th>
    </tr>
    <tr>
        <td>Period 1</td>
        <td>8:35 AM</td>
